export const en = {
  ...
  "chat-project-passthrough-subtotal": "Pass-through subtotal",
  "chat-project-labor": "Build & delivery (Obed)",
  "chat-project-total": "Project total",
  "chat-project-pay-deposit": "Pay deposit {amount}",
  "chat-project-pay-full": "Pay {amount}",
