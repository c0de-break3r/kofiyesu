...
const projectPageClass =
  "min-h-screen bg-white px-6 py-24 pt-20 text-[var(--text)] md:pt-28 [--bg:#ffffff] [--bg-elevated:#fafafa] [--border:rgba(26,29,33,0.08)] [--text:#1a1d21] [--text-muted:#6b7280] pb-[calc(72px+env(safe-area-inset-bottom,0px))] md:pb-28";
